                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
                        ...
                        <div className="md:col-span-2">
                            ...
                            <ul className="space-y-2">
                                <li><a href="#contact" className="text-white hover:text-gray-400">{t('Footer.contactus')}</a></li>
                                <li><Link to="/privacypolicy" className="text-white hover:text-gray-400">{t('Footer.policy')}</Link></li>
                            </ul>
                        </div>
                    </div>
