...
function Hero() {
  ...
  return (
    <>
      <div  className='max-w-[6840px] max-h-[780px] lg:max-h-[630px] xxs:min-h-[530px] flex flex-col md:flex-row sm:flex-row ss:flex-row xs:flex-row xxs:flex-row items-center justify-center bg-cover bg-center text-white relative z-0' style={{
        ...
        <div className="left-side flex flex-col justify-center px-16 text-center lg:w-4/5 md:w-1/2 sm:w-2/3 ss:w-4/5 xs:w-4/5 xxs:w-full lg:pb-32 md:pb-72 sm:pb-64 ss:pb-72 xs:pb-42 xs:pl-8 sm:me-2 xxs:p-8 sm:pl-6 ss:pl-4 xxs:pb-52 sm:mr-8 md:text-left sm:text-left sm:text-lg ss:text-left xs:text-left xxs:text-left ">
          ...
          <p className=" text-3xl pb-2 md:text-2xl sm:text-2xl ss:text-xl xs:text-sm xxs:text-xs xxs:mr-3 xxs:pb-0 text-opacity-50 uppercase" style={{ fontFamily: "Arimo, sans-serif", fontWeight: 400 }}>{t('left_side_hero.subheading')}</p>
